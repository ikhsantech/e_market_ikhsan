...
@endforeach
  ...
  <form id="formTransaksi" class=""  method="post" action="pembelian">
     @csrf
    <div class="row">
        <div class="col-6">
        ...
        <div class="col-6">
          <label class="control-label col-sm-6 col-xs-12 form-group">tanggal pembelian</label>
          <div class="col-md-6 col-sm-6 col-sx-12">
            <input type="date" class="date-picker form-control col-md-7 col-xs-12" name="tanggal_masuk" required="required" value="{{date('Y-m-d')}}">
          </div>
        </div>
    </div>
...
@endforeach
      ...
      <div class="row justify-content-end" style="text-align: right;">
        ...
        <div class="col-md-3 mr-md-auto" style="padding-right:10px; align-content:right;">
          <input type="text" class="form-control col-md-8 col-xs-12" style="margin-left:80px;" required="required" id="totalHarga" readonly name="total">
        </div>
      </div>
...
$('#tblTransaksi').on('click','.btnRemoveBarang',function(){
  ...
  if(tbody == 0)
   $('#tblTransaksi tbody')
  .append('<tr><td colspan="6" style ="text-align:center;font-style:italic">Data Belum Ada</td></tr>')
...
function tambahBarang(a){ 
          ...
          data += '<td><button type="button" class="btnRemoveBarang btn-danger"><span class="fas fa-times"></span></button></td>'; 
          data += '</tr>'; 
